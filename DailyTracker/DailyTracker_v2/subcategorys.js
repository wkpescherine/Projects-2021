    ...
    render(){
        return(
            <div>
                ...
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("MobileDeviceConstantService")}>MobileDeviceConstantService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("MutateJobService")}>MutateJobService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("OfflineUserDataJobService")}>OfflineUserDataJobService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("OperatingSystemVersionConstantService")}>OperatingSystemVersionConstantService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("PaidOrganicSearchTermViewService")}>PaidOrganicSearchTermViewService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("ParentalStatusViewService")}>ParentalStatusViewService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("PaymentsAccountService")}>PaymentsAccountService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("ProductBiddingCategoryConstantService")}>ProductBiddingCategoryConstantService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("ProductGroupViewService")}>ProductGroupViewService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("RecommendationService")}>RecommendationService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("RemarketingActionService")}>RemarketingActionService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("SearchTermViewService")}>SearchTermViewService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("SharedCriterionService")}>SharedCriterionService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("SharedSetService")}>SharedSetService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("ShoppingPerformanceViewService")}>ShoppingPerformanceViewService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("TopicConstantService")}>TopicConstantService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("TopicViewService")}>TopicViewService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("UserInterestService")}>UserInterestService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("UserListService")}>UserListService</button>
                }
                {this.props.data === "APIServices" && 
                    <button onClick={()=>this.props.submitSubCategory("VideoService")}>VideoService</button>
                }
                {this.props.data === "GoogleAdsAPIMigration" && 
                    <button onClick={()=>this.props.submitSubCategory("FAQ")}>FAQ</button>
                }
                {this.props.data === "GoogleAdsAPIMigration" && 
                    <button onClick={()=>this.props.submitSubCategory("Non FAQ")}>Non FAQ</button>
                }
                {this.props.data === "ClientLibrary" && 
                    <button onClick={()=>this.props.submitSubCategory(".NET")}>.NET</button>
                }
                {this.props.data === "ClientLibrary" && 
                    <button onClick={()=>this.props.submitSubCategory("Google Ads API Migration")}>Google Ads API Migration</button>
                }
                {this.props.data === "ClientLibrary" && 
                    <button onClick={()=>this.props.submitSubCategory("Java")}>Java</button>
                }
                {this.props.data === "ClientLibrary" && 
                    <button onClick={()=>this.props.submitSubCategory("Perl")}>Perl</button>
                }
                {this.props.data === "ClientLibrary" && 
                    <button onClick={()=>this.props.submitSubCategory("PHP")}>PHP</button>
                }
                {this.props.data === "ClientLibrary" && 
                    <button onClick={()=>this.props.submitSubCategory("Python")}>Python</button>
                }
                {this.props.data === "ClientLibrary" && 
                    <button onClick={()=>this.props.submitSubCategory("Ruby")}>Ruby</button>
                }
                {this.props.data === "ClientLibrary" && 
                ...
                {this.props.data === "OAuthSetup" && 
                    <button onClick={()=>this.props.submitSubCategory("Invalid_grant")}>Invalid_grant</button>
                }
                {this.props.data === "OAuthSetup" && 
                    <button onClick={()=>this.props.submitSubCategory("TOS")}>TOS</button>
                }
                {this.props.data === "OAuthSetup" && 
                    <button onClick={()=>this.props.submitSubCategory("User Permission denied")}>User Permission denied</button>
                }
                {this.props.data === "OAuthSetup" && 
                    <button onClick={()=>this.props.submitSubCategory("Others")}>Others</button>
                }
